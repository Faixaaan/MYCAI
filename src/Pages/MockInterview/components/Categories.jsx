...
const Categories = () => {
  ...
  const GetBannerData = async () => {
    try {
      ...
      const catgeoriesRes = await axiosInstance.get(endpoints.mock.categories);
      console.log(catgeoriesRes?.data?.mockCategory, "bannerdata");
      setCategoriesData(catgeoriesRes?.data?.mockCategory);
      setData(res?.data);
    } catch (err) {
      console.error(
