        ...
        <Container maxWidth="xl">
            ...
            <Grid container spacing={2}>
              <Grid size={{ sm: 12, md: 2.5 }}>
                ...
                >
                  ...
                  >
                    Identify, develop, and execute impactful CVI business
                    strategies.
                  </Typography>
                  <Box
                    sx={{
                          ...
                          >
                            <Card
                              sx={{
                                ...
                                p: 2,
                                background:
                                  "linear-gradient(to bottom right, #f8fbff, #e9f0ff)",
                              }}
                            >
                              <CardActionArea
                                sx={{
          ...
          <Box>
            ...
            <Grid
              ...
              sx={{ padding: { sm: "0px 50px", xs: "0px 20px" } }}
            >
